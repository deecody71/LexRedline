...
<body>
  ...
  return (
    <div className="flex flex-col lg:flex-row w-full h-auto lg:h-[calc(100vh-4rem)]">
      ...
      <div className="w-full lg:w-[70%] xl:w-[72%] 2xl:w-[75%] overflow-auto bg-slate-100 p-4 min-h-[50vh] lg:min-h-full">
      ...
      <div className="w-full lg:w-[30%] xl:w-[28%] 2xl:w-[25%] border-t lg:border-t-0 lg:border-l border-slate-200 bg-white overflow-y-auto">
